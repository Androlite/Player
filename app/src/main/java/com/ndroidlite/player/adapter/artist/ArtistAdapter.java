package com.ndroidlite.player.adapter.artist;
...
public class ArtistAdapter extends AdlMultiSelectAdapter<ArtistAdapter.ViewHolder, Artist> implements FastScrollRecyclerView.SectionedAdapter  {

package com.ndroidlite.player.adapter.album;
...
public class AlbumAdapter extends AdlMultiSelectAdapter<AlbumAdapter.ViewHolder, Album> implements FastScrollRecyclerView.SectionedAdapter {

...
import com.ndroidlite.player.fragments.player.PlayerAlbumCoverFragment;
 ...
 */
public class FlatPlayerFragment extends AdlPlayerFragment implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener  {
    ...
    private static abstract class BaseImpl implements Impl {
        ...
        public AnimatorSet createDefaultColorChangeAnimatorSet(int newColor) {
            ...
            animatorSet.setDuration(ViewUtil.PLAYER_ANIM_TIME);
            return animatorSet;
        }
    ...
    private static class PortraitImpl extends BaseImpl {
        ...
        public void setUpPanelAndAlbumCoverHeight() {
            ...
            final int minPanelHeight = (int) ViewUtil.convertDpToPixel(8 + 72 + 24, fragment.getResources()) + fragment.getResources().getDimensionPixelSize(R.dimen.dimen_20dp) + fragment.getResources().getDimensionPixelSize(R.dimen.dimen_104dp);
            ...
            ((AdlSlidingMusicPanelActivity) fragment.getActivity()).setAntiDragView(fragment.slidingUpPanelLayout.findViewById(R.id.player_panel));
        }
    ...
    private static class LandscapeImpl extends BaseImpl {
        ...
        @Override
        public void setUpPanelAndAlbumCoverHeight() {
            ((AdlSlidingMusicPanelActivity) fragment.getActivity()).setAntiDragView(fragment.getView().findViewById(R.id.player_panel));
        }

...
public abstract class AdlLibraryPagerRecyclerViewFragment <A extends RecyclerView.Adapter, LM extends RecyclerView.LayoutManager> extends AdlLibraryPagerFragment implements AppBarLayout.OnOffsetChangedListener {
    public static final String TAG = AdlLibraryPagerRecyclerViewFragment.class.getSimpleName();

...
public class LibraryFragment extends AdlMainActivityFragment implements CabHolder, MainActivity.MainActivityFragmentCallbacks, ViewPager.OnPageChangeListener {
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        ...
        if (currentFragment instanceof AdlLibraryPagerRecyclerViewCustomGridSizeFragment && currentFragment.isAdded()) {
            AdlLibraryPagerRecyclerViewCustomGridSizeFragment absLibraryRecyclerViewCustomGridSizeFragment = (AdlLibraryPagerRecyclerViewCustomGridSizeFragment) currentFragment;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        Fragment currentFragment = getCurrentFragment();
        if (currentFragment instanceof AdlLibraryPagerRecyclerViewCustomGridSizeFragment) {
            AdlLibraryPagerRecyclerViewCustomGridSizeFragment absLibraryRecyclerViewCustomGridSizeFragment = (AdlLibraryPagerRecyclerViewCustomGridSizeFragment) currentFragment;
    ...
    private void setUpGridSizeMenu(@NonNull AdlLibraryPagerRecyclerViewCustomGridSizeFragment fragment, @NonNull SubMenu gridSizeMenu) {
    ...
    private boolean handleGridSizeMenuItem(@NonNull AdlLibraryPagerRecyclerViewCustomGridSizeFragment fragment, @NonNull MenuItem item) {
        int gridSize = 0;

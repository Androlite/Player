package com.ndroidlite.player.fragments.player.card;
 ...
 */
public class CardPlayerFragment extends AdlPlayerFragment
        implements PlayerAlbumCoverFragment.Callbacks, SlidingUpPanelLayout.PanelSlideListener {

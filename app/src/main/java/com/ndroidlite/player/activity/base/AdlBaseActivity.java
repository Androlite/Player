...
public abstract class AdlBaseActivity extends AdlThemeActivity {
        ...
        if (requestCode == PERMISSION_REQUEST) {
            for (int grantResult : grantResults) {
                if (grantResult != PackageManager.PERMISSION_GRANTED) {
                    if (ActivityCompat.shouldShowRequestPermissionRationale(AdlBaseActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                        ...
                        Snackbar.make(getSnackBarContainer(), getPermissionDeniedMessage(),
                                ...
                                .setAction(R.string.action_settings, new View.OnClickListener() {
                                    ...
                                    public void onClick(View view) {
                                        ...
                                        Uri uri = Uri.fromParts("package", AdlBaseActivity.this.getPackageName(), null);
                                        intent.setData(uri);

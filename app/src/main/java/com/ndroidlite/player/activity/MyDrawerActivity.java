...
/**
 * Created by chiragpatel on 05-07-2017.
 */
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.nav_settings:
                        startActivity(new Intent(MyDrawerActivity.this, SettingsActivity.class));
                        break;

                    case R.id.nav_about:
                        startActivity(new Intent(MyDrawerActivity.this, AboutActivity.class));
                        break;
                }
                return true;
            }
    ...
    private boolean checkShowIntro() {
        if (!PreferenceUtil.getInstance(this).introShown()) {
            ...
            new Handler().postDelayed(new Runnable() {
                @Override
                public void run() {
                    startActivityForResult(new Intent(MyDrawerActivity.this, AppIntroActivity.class), APP_INTRO_REQUEST);
                }
            }, 50);
            return true;
        }

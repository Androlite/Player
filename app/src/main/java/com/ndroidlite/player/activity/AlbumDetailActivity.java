...
public class AlbumDetailActivity extends AdlSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Album>  {
    ...
    private void loadAlbumCover() {
        SongGlideRequest.Builder.from(Glide.with(this), getAlbum().safeGetFirstSong())
                ...
                .into(new PlayerColoredTarget(albumArtImageView) {
                    @Override
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (id) {
           ...
           /* case R.id.action_tag_editor:
                ...
                intent.putExtra(AdlTagEditorActivity.EXTRA_ID, getAlbum().getId());

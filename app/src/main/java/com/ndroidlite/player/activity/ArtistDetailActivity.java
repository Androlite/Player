...
import com.ndroidlite.player.interfaces.PaletteColorHolder;
import com.ndroidlite.player.loader.ArtistLoader;
import com.ndroidlite.player.misc.SimpleObservableScrollViewCallbacks;
import com.ndroidlite.player.misc.WrappedAsyncTaskLoader;
import com.ndroidlite.player.model.Artist;
import com.ndroidlite.player.utils.ArtistSignatureUtil;
...
public class ArtistDetailActivity extends AdlSlidingMusicPanelActivity implements PaletteColorHolder, CabHolder, LoaderManager.LoaderCallbacks<Artist> {
    ...
    private void setUpObservableListViewParams() {
        ...
        titleViewHeight = getResources().getDimensionPixelSize(R.dimen.dimen_72dp);
        headerOffset = toolbarHeight;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            headerOffset += getResources().getDimensionPixelSize(R.dimen.dimen_24dp);
        }
    }
    ...
    private void loadArtistImage(final boolean forceDownload) {
        ...
        Glide.with(this)
                ...
                .into(new PlayerColoredTarget(artistImage) {
                    @Override

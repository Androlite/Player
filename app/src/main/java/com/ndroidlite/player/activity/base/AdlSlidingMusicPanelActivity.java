package com.ndroidlite.player.activity.base;
...
import com.ndroidlite.player.fragments.player.MiniPlayerFragment;
import com.ndroidlite.player.fragments.player.NowPlayingScreen;
import com.ndroidlite.player.fragments.player.card.CardPlayerFragment;
import com.ndroidlite.player.fragments.player.flat.FlatPlayerFragment;
...
public abstract class AdlSlidingMusicPanelActivity extends AdlMusicServiceActivity implements SlidingUpPanelLayout.PanelSlideListener, CardPlayerFragment.Callbacks {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        playerFragment = (AdlPlayerFragment) getSupportFragmentManager().findFragmentById(R.id.player_fragment_container);
    ...
    public void hideBottomBar(final boolean hide) {
        if (hide) {
            ...
            slidingUpPanelLayout.setPanelHeight(getResources().getDimensionPixelSize(R.dimen.dimen_56dp));
        }
    }
    ...
    private void animateNavigationBarColor(int color) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            navigationBarColorAnimator = ValueAnimator
                    ...
                    .setDuration(ViewUtil.PLAYER_ANIM_TIME);
            navigationBarColorAnimator.setInterpolator(new PathInterpolator(0.4f, 0f, 1f, 1f));
            navigationBarColorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
                @TargetApi(Build.VERSION_CODES.LOLLIPOP)
                @Override
                public void onAnimationUpdate(ValueAnimator animation) {
                    AdlSlidingMusicPanelActivity.super.setNavigationbarColor((Integer) animation.getAnimatedValue());
                }
            });
    ...
    public AdlPlayerFragment getPlayerFragment() {

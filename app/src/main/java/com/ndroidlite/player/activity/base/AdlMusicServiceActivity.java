...
public abstract class AdlMusicServiceActivity extends AdlBaseActivity implements MusicServiceEventListener {
    public static final String TAG = AdlMusicServiceActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serviceToken = MusicPlayerRemote.bindToService(this, new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                AdlMusicServiceActivity.this.onServiceConnected();
            }

            @Override
            public void onServiceDisconnected(ComponentName name) {
                AdlMusicServiceActivity.this.onServiceDisconnected();
            }
        });
    ...
    private static final class MusicStateReceiver extends BroadcastReceiver {
        ...
        private final WeakReference<AdlMusicServiceActivity> reference;

        public MusicStateReceiver(final AdlMusicServiceActivity activity) {
        ...
        public void onReceive(final Context context, @NonNull final Intent intent) {
            ...
            AdlMusicServiceActivity activity = reference.get();
            if (activity != null) {
                switch (action) {

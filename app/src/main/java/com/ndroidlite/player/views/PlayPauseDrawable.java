package com.ndroidlite.player.views;
...
public class PlayPauseDrawable extends Drawable {
    ...
    public PlayPauseDrawable(@NonNull Context context) {
        ...
        pauseBarWidth = res.getDimensionPixelSize(R.dimen.dimen_4dp);
        pauseBarHeight = res.getDimensionPixelSize(R.dimen.dimen_14dp);
        pauseBarDistance = res.getDimensionPixelSize(R.dimen.dimen_4dp);
    }
